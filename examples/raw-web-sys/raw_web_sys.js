/* tslint:disable */
import * as wasm from './raw_web_sys_bg';
...
const __widl_f_get_elements_by_tag_name_Document_target = Document.prototype.getElementsByTagName || function() {
    throw new Error(`wasm-bindgen: Document.prototype.getElementsByTagName does not exist`);
};
...
const __widl_f_get_with_index_HTMLCollection_target = function(y) {
    return this[y];
};

export function __widl_f_get_with_index_HTMLCollection(arg0, arg1) {

    const val = __widl_f_get_with_index_HTMLCollection_target.call(getObject(arg0), arg1);
    return isLikeNone(val) ? 0 : addHeapObject(val);
